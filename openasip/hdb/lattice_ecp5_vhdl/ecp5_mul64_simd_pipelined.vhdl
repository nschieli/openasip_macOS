...
entity ecp5_mul64_simd_pipelined is
  port (
    clk          : in  std_logic;
    rstx         : in  std_logic;
...
end entity ecp5_mul64_simd_pipelined;

architecture rtl of ecp5_mul64_simd_pipelined is

  -- Opcodes (alphabetical: mac64, mac8x8, mul64, requant)
  constant OP_MAC64   : std_logic_vector(1 downto 0) := "00";
  constant OP_MAC8X8  : std_logic_vector(1 downto 0) := "01";
  constant OP_MUL64   : std_logic_vector(1 downto 0) := "10";
  ...
  ---------------------------------------------------------------------------
  signal op_s1_r      : std_logic_vector(1 downto 0);
  ...
  signal op_s2_r      : std_logic_vector(1 downto 0);
  ...
  -- Stage 2: 32×32→64 multiply, round, shift, offset, clamp
  ---------------------------------------------------------------------------
...
begin
  ...
  --   mac8x8: acc + tree_sum(registered products)
